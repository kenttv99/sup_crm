...
async def check() -> int:
    ...
    from bot.services.topics import _telegram_value, validate_support_chat
    ...
    try:
        ...
        print(f"chat_type: {_telegram_value(chat.type)}")
        ...
        print(f"bot_member_status: {_telegram_value(member.status)}")
